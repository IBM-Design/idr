...
Sponsor Users are an IBM Design Thinking Key. A Sponsor User Program formalizes and scales these relationships. IBMers and end users co-create design solutions through continuous and iterative research and design. The program is not a channel for feature requests. Instead, insights gathered from the users, along with other research activities, inform your team’s Hills, roadmap, and offering.
...
Below you’ll find checklists, handy pro-tips and your feedback program. Questions or comments? Find us in the IBM Studios slack on #ibm-design-research.
