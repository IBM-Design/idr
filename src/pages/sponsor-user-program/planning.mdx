...
- Identify a rough time frame of when the program will start and end, and determine time expectations for client participants.
...
- Download a [research template](https://idr-public.netlify.com/research-in-practice/plan-for-success#get-started).
...
- IBM's Design Program Office recommends 5-8 users, total, from a variety of companies. This number will vary, however, and should be tailored to the needs of your project and team.
