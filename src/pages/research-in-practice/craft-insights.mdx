...
<Row className="resource-card-group">
  <Column noGutterSm={true} colSm={4} colMd={2} colMd={3} colLg={4}>
    <ResourceCard
      ...
      aspectRatio="2:1"
      href="http://www.servicedesigntoolkit.org/assets2013/posters/EN/F1-research%20questions-A1.pdf"
    />
  </Column>
</Row>
...
<Row className="resource-card-group">
  <Column noGutterSm={true} colSm={4} colMd={2} colMd={3} colLg={4}>
    <ResourceCard
      ...
      aspectRatio="2:1"
      href="https://www.ibm.com/design/thinking/page/toolkit/activity/as-is-scenario-map"
    />
  </Column>
</Row>
