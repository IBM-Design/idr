...
One way to formalize this process is with a [Sponsor User Program](https://www.ibm.com/design/research/sponsor-user-program/overview). Sponsor Users are a core part of [Enterprise Design Thinking](https://www.ibm.com/design/thinking/page/framework) and IBM Design Research. They help us design experiences for real target users rather than assumed needs. You can read more about Sponsor User Programs, including how to start and run one, below.
