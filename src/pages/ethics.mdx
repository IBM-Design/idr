...
One way to formalize this process is with a Sponsor User Program (link to new page you're making). Sponsor Users are a core part of Enterprise Design Thinking (link) and IBM Design Research, and help us design experiences for real target users rather than assumed needs. You can read more about Sponsor User Programs, including how to start and run one, below.
